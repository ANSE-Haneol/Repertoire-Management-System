...
import listener.RomanticAdderListener;

public class RomanticAdder extends JPanel {
	
	MusicManager musicManager;
	WindowFrame frame;
	
	public RomanticAdder(WindowFrame frame, MusicManager musicManager) {
		this.frame = frame;
		...
		saveButton.addActionListener(new RomanticAdderListener(fieldComposer, fieldTitle, fieldGenre, musicManager, frame));
